<div align="text-center">
    ...
    @if (in_array('status', $buttons))
          @if ($status =='active')
            <button type="button" data-prefix="{{$prefix}}" class="btn btn-warning btn-sm  status " title="Disable {{$prefix}}" data-status="active" data-id="{{$id}}">
              <i class="fas fa-ban"></i>
            </button>
          @else
            <button type="button" data-prefix="{{$prefix}}" class="btn btn-success btn-sm status " title="Enable {{$prefix}}" data-status="inactive" data-id="{{$id}}">
