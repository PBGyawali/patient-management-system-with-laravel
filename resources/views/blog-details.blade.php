@include('layouts.new_header')
        ...
        <div class="page-wrapper">
          @include('message')  <div class="content">
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <div class="blog-view">
                            <article class="blog blog-single-post">
                                ...
                                <div class="blog-image">
                                    <a href="#."><img alt="" src="{{asset('img')}}/blog/blog-01.jpg" class="img-fluid"></a>
                                </div>
                                ...
                                <div class="about-author">
                                    <div class="about-author-img">
                                        <div class="author-img-wrap">
                                            <img class="img-fluid rounded-circle" alt="" src="{{asset('img')}}/user.jpg">
                                        </div>
                                    </div>
                                    ...
                                    <li>
                                        <div class="comment">
                                            <div class="comment-author">
                                                <img class="avatar" alt="" src="{{asset('img')}}/user.jpg">
                                            </div>
                            ...
                            <ul class="latest-posts">
                                <li>
                                    <div class="post-thumb">
                                        <a href="blog-details">
                                            <img class="img-fluid" src="{{asset('img')}}/blog/blog-thumb-01.jpg" alt="">
                                        </a>
                                    </div>
                                    <div class="post-info">
                                        <h4>
                                ...
                                <li>
                                    <div class="post-thumb">
                                        <a href="blog-details">
                                            <img class="img-fluid" src="{{asset('img')}}/blog/blog-thumb-02.jpg" alt="">
                                        </a>
                                    </div>
                                    <div class="post-info">
                                        <h4>
                                ...
                                <li>
                                    <div class="post-thumb">
                                        <a href="blog-details">
                                            <img class="img-fluid" src="{{asset('img')}}/blog/blog-thumb-03.jpg" alt="">
                                        </a>
                                    </div>
                                    <div class="post-info">
                                        <h4>
                                ...
                                <li>
                                    <div class="post-thumb">
                                        <a href="blog-details">
                                            <img class="img-fluid" src="{{asset('img')}}/blog/blog-thumb-04.jpg" alt="">
                                        </a>
                                    </div>
                                    <div class="post-info">
                                        <h4>
